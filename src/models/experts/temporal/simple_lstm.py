...
class Temporal_LSTM(nn.Module):
    ...
    """
    def __init__(self, input_size, hidden_dim, num_layers, feature_dim):
        ...
        # Final projection to feature_dim dimensions
        self.final_proj = nn.Linear(self.hidden_size, self.feature_dim)
    ...
    def forward(self, x):
        ...
        output = self.final_proj(output)  # [batch_size, feature_dim]
